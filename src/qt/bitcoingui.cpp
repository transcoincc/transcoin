                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TRNS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TRNS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and transcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTRNS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TRNS Core"), this);
    aboutAction->setStatusTip(tr("Show information about TRNS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TRNS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TRNS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TRNS addresses"));
    ...
    openAction->setStatusTip(tr("Open a TRNS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TRNS Core help message to get a list with possible TRNS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TRNS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TRNS network", "", count));
}
...
{
    QString strTitle = tr("TRNS Core"); // default title
