                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received TransCoin from zTransCoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTransCoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTransCoin));
