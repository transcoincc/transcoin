...
/** Utility functions used by the TRNS Qt UI.
 */
namespace GUIUtil
{
...
// Render TRNS addresses in monospace font
...
// Parse "transcoin:" URI into recipient object, return true on successful parsing
