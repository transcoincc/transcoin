...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TransCoin features */
        {"transcoin", "masternode", &masternode, true, true, false},
        {"transcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"transcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"transcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"transcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"transcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"transcoin", "startmasternode", &startmasternode, true, true, false},
        {"transcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"transcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"transcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"transcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"transcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"transcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"transcoin", "mnbudget", &mnbudget, true, true, false},
        {"transcoin", "preparebudget", &preparebudget, true, true, false},
        {"transcoin", "submitbudget", &submitbudget, true, true, false},
        {"transcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"transcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"transcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"transcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"transcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"transcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"transcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"transcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"transcoin", "mnsync", &mnsync, true, true, false},
        {"transcoin", "spork", &spork, true, true, false},
        {"transcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"transcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use transcoind, or the -server option to transcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> transcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:48303/\n";
}
