...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TransCoin Core transcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  transcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded transcoin transaction") + "\n" +
                               "  transcoin-tx [options] -create [commands]   " + _("Create hex-encoded transcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded transcoin transaction
