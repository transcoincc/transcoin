Contributing to TRNS Core
============================

The TRNS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TRNS Core project, and is not to be
confused with overall TRNS Network Protocol consensus changes.

Whether a pull request is merged into TRNS Core rests with the project merge
...
Patches that change TRNS consensus rules are considerably more involved than
...
Where a patch set proposes to change the TRNS consensus, it must have been
...
The project leader is the release manager for each TRNS Core release.
