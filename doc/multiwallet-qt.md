...
In order to support loading of multiple wallets in transcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is transcoin.cpp.
...
Changes to transcoin.cpp
----------------------
transcoin.cpp is the entry point into transcoin-qt, and as such, will require some minor modifications to provide hooks for
