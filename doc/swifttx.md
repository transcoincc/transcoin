...
This mechanism has been integrated into Bitcore-Node-TRNS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TRNS-Project/insight-api-transcoin#web-socket-api](https://github.com/TRNS-Project/insight-api-transcoin#web-socket-api) 
* API: [https://github.com/TRNS-Project/insight-api-transcoin#swifttx-transactions](https://github.com/TRNS-Project/insight-api-transcoin#swifttx-transactions) 
...
By default, the TRNS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TRNS Core daemon:
