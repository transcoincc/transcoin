...
#   c) node1 mines 32 blocks, so now node 0 has 60001transcoin, node 1 has 4250transcoin, node2 has none.
#   d) node0 sends 601 transcoin to node2, in two transactions (301 transcoin, then 300 transcoin).
