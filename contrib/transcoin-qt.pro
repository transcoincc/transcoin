...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/transcoin-cli.cpp \
           src/transcoin-tx.cpp \
           src/transcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/transcoin.qrc src/qt/transcoin_locale.qrc

TRANSLATIONS += src/qt/locale/transcoin_bg.ts \
                src/qt/locale/transcoin_de.ts \
                src/qt/locale/transcoin_en.ts \
                src/qt/locale/transcoin_es.ts \
                src/qt/locale/transcoin_fi.ts \
                src/qt/locale/transcoin_fr.ts \
                src/qt/locale/transcoin_it.ts \
                src/qt/locale/transcoin_ja.ts \
                src/qt/locale/transcoin_pl.ts \
                src/qt/locale/transcoin_pt.ts \
                src/qt/locale/transcoin_ru.ts \
                src/qt/locale/transcoin_sk.ts \
                src/qt/locale/transcoin_sv.ts \
                src/qt/locale/transcoin_vi.ts \
                src/qt/locale/transcoin_zh_CN.ts \
                src/qt/locale/transcoin_zh_TW.ts
